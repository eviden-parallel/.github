...
3. To avoid concurent work on the same task, assign the issue(s) to yourself or if you are _external contributor_, add a comment to ask @eviden-parallel/maintainers to be assigned the issue.
